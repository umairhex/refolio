                ...
                >
                  ...
                  >
                    <Link
                      ...
                      className="relative block w-full text-[14vw] md:text-[10vw] lg:text-[90px] font-medium leading-none tracking-tighter uppercase cursor-pointer py-3 md:py-5 focus:outline-none"
                      style={{
